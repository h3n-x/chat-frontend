# Chat Anónimo - Glassmorphism Design

Una aplicación de chat anónimo en tiempo real con un diseño moderno inspirado en el glassmorphism de Apple. Esta es una implementación frontend puramente visual que demuestra las capacidades de diseño sin funcionalidad backend real.
